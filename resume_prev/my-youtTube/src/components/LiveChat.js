  ...
  useEffect(() => {
    ...
    return (
        <>
            {
                !isShowChat ?
                    (<div className=' w-[204px] h-[20px]  mx-3 text-center'><button onClick={() => setIsShowChat(true)} className='rounded-full hover:bg-gray-200 border py-1 w-full text-[14px]'>Show Chat</button></div>)
                    :
                    (
                        <div className='w-[500px] h-[700px] border rounded-lg '>
                            ...
                            <form onSubmit={(e) => handleSubmit(e)}>
                                <div className='flex px-3 my-2'>
                                    ...
                                    <div className='px-3 '>
                                        <div className='font-medium text-[13px] text-gray-500'>Harsh Dasila</div>
                                        <input value={liveMessage} onChange={(e) => setLiveMessage(e.target.value)} maxLength="200" className='border-b-[1px] border-gray-400 h-7 outline-none text-[13px] w-[300px] focus:border-blue-500 focus:border-b-[2px] pb-2' type='text' placeholder='Chat...' />
